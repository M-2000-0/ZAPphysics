...
class DemoBrowser(ctk.CTkFrame):
    ...
    DEMOS = {
        "orbital": ("Orbital Mechanics", "examples/demo_orbital.zpx", "N-body orbital simulation with Hohmann transfers"),
        ...
        "porkchop": ("Porkchop Plot", "examples/demo_porkchop.zpx", "Launch window analysis Earth→Mars"),
        "rocket": ("Rocket Engineering", "examples/demo_rocket.zpx", "Multi-stage rocket design & trajectory"),
        ...
        "chemistry": ("Chemistry Lab", "examples/chemistry.zpx", "Molecules, reactions, thermodynamics"),
        ...
        "art": ("Generative Art", "examples/demo_art.zpx", "Particle fountains, spirals, bursts"),
